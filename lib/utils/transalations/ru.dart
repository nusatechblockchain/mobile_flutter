const Map<String, String> ru = {
  ...
  'register.screen.field.agree': "Я согласен с Naga Exchange's",
  ...
  'account.screen.instructions':
      'Пожалуйста, не разглашайте коды SMS и аутентификации Google никому, включая службу поддержки Naga Exchange.',
  ...
  'referral.screen.referral_description':
      'Зарабатывайте до 40% комиссии каждый раз, когда ваш друг совершает сделку на Naga.',
  ...
  'crypto_deposit.screen.tag.instruction':
      'Введите данные тега и адреса, которые необходимы для успешного внесения @currency на ваш счет Naga.',
  ...
  'crypto_withdraw.screen.instruction2':
      'При выводе на адрес пользователя Naga комиссия за обработку будет возвращена на Текущий счет по умолчанию.',
