Map<String, String> serverMessages = {
  ...
  'page.body.landing.register.item.text':
      'Naga Exchange offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
  'page.body.landing.register.item.button': 'register',

  'page.body.landing.features.title':
      'Naga Exchange platform features',
  ...
  'page.body.landing.features.features.item1.text':
      'Naga Exchange offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
  'page.body.landing.features.features.item2.text':
      'Naga Exchange offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
  ...
  'page.body.landing.tradeOnTheGo.item.text3':
      'All the power of Naga Exchange cryptocurrency exchange, in the palm of your hand.',
  ...
  'page.body.landing.footer.rights':
      'Naga Exchange & Exchange © All rights reserved',
  ...
  'page.body.deposit.network.tag.instruction':
      'Please enter both Tag and Address data, which are required to deposit {currency} to your Naga account successfully.',
  ...
  'page.body.withdraw.tips.tip2':
      "When withdrawing to the Naga user's address, the handling fee will be returned to the Current Account by default.",
  ...
  'page.body.profile.tabs.referral.description':
      'EARN UP TO 40% COMMISSION EVERY TIME YOUR FRIENDS MAKE A TRADE ON Naga.',
