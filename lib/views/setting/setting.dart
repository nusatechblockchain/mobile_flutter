...
import 'package:naga_exchange/views/referral_program/referral_program.dart';
import 'package:naga_exchange/views/setting/themes.dart';
import 'package:naga_exchange/views/webview_container.dart';
...
class Setting extends StatelessWidget {
  ...
  void share(BuildContext context) {
    var shareLink =
        'Naga Exchange\nFor Android: https://play.google.com/store/apps/details?id=com.nagaexchange.android\nFor IOS: https://apps.apple.com/us/app/naga_exchange/id1491304459';
              ...
              child: GestureDetector(
                onTap: () {
                  Get.to(WebViewContainer('Help/Support',
                      'https://support.nagaexchange.com/lhc/lhc_web/index.php/chat/start'));
                },
            ...
            InkWell(
                onTap: () {
                  Get.to(WebViewContainer(
                      'Fee', 'https://ewallet.nagaexchange.com/fee'));
                },
                child: listSetting(
                    context,
                    Icon(
