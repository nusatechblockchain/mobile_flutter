const Map<String, String> ml = {
  ...
  'register.screen.field.agree': "Saya bersetuju dengan Naga Exchange's",
  ...
  'account.screen.instructions':
      'Jangan dedahkan SMS dan kod Pengesahan Google kepada sesiapa sahaja, termasuk sokongan Dompet Naga.',
  ...
  'referral.screen.referral_description':
      'Dapatkan komisen hingga 40% setiap kali rakan anda melakukan perdagangan di Naga.',
  ...
  'crypto_deposit.screen.tag.instruction':
      'Sila masukkan kedua-dua data Tag dan Alamat, yang diperlukan untuk berjaya memasukkan @currency ke akaun Naga anda.',
  ...
  'crypto_withdraw.screen.instruction2':
      'Semasa menarik ke alamat pengguna Naga, bayaran pengendalian akan dikembalikan ke Akaun Semasa secara lalai.',
