...
import 'package:naga_exchange/controllers/fiat_deposit_controller.dart';
  ...
  Future<void> getDepositDetails() async {
    try {
      ...
      var response = await get(
          'https://ewallet.nagaexchange.com/public_data/bank_details.json');
    ...
    "banks": [
      {
        ...
        "Account holder": 'Naga Group of Companies, S.L',
