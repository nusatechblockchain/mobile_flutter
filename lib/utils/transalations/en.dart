const Map<String, String> en = {
  ...
  'register.screen.field.agree': "I agree to Naga Exchange's",
  ...
  'account.screen.instructions':
      'Please do not disclose SMS and Google Authentication codes to anyone, including Naga Exchange support.',
  ...
  'referral.screen.referral_description':
      'Earn up to 40% commission every time your friend makes a trade on Naga.',
