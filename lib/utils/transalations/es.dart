const Map<String, String> es = {
  ...
  'register.screen.field.agree': "Estoy de acuerdo con Naga Exchange's",
  ...
  'account.screen.instructions':
      'No revele los códigos SMS ni de autenticación de Google a nadie, incluido el soporte de Naga Exchange.',
  ...
  'referral.screen.referral_description':
      'Gane hasta un 40% de comisión cada vez que su amigo realice una operación en Naga.',
  ...
  'crypto_deposit.screen.tag.instruction':
      'Ingrese los datos de la etiqueta y la dirección, que son necesarios para depositar @currency en su cuenta Naga con éxito.',
  ...
  'crypto_withdraw.screen.instruction2':
      'Al retirarse a la dirección del usuario de Naga, la tarifa de manejo se devolverá a la cuenta corriente de forma predeterminada.',
